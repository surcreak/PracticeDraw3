...
public class Practice14GetFontMetricsView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float yOffect = -(metrics.ascent + metrics.descent) / 2;

        int middle = (top + bottom) / 2;
        canvas.drawText(texts[0], 100, middle + yOffect, paint2);
        canvas.drawText(texts[1], 200, middle + yOffect, paint2);
        canvas.drawText(texts[2], 300, middle + yOffect, paint2);
        canvas.drawText(texts[3], 400, middle + yOffect, paint2);
        canvas.drawText(texts[4], 500, middle + yOffect, paint2);
        canvas.drawText(texts[5], 600, middle + yOffect, paint2);
    }
}
